...
class Admin::LibrariesControllerTest < ActionController::TestCase
  def test_index
    get :index
  ...
  def test_create_valid
    ...
    post :create
    assert_redirected_to admin_library_url(assigns(:library))
  end
  ...
  def test_destroy
    ...
    assert_redirected_to admin_libraries_url
